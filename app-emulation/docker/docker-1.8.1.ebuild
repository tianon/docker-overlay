...
if [[ ${PV} = *9999* ]]; then
	# Docker cannot be fetched via "go get", thanks to autogenerated code (hence the EVCS_OFFLINE here)
	EVCS_OFFLINE=1 inherit golang-vcs
	...
	EVCS_OFFLINE=1 inherit golang-vcs-snapshot
fi
